...
$GLOBALS['db_user'] = "transnum_user";
$GLOBALS['db'] = "numelops_asso_trans";
$GLOBALS['db_pwd'] = "WUNAzP5hw2si2EnQjavy";
}
else {
$GLOBALS['db_server'] = "localhost";
$GLOBALS['db_user'] = "transnum_user";
...
$GLOBALS['pub_hash'] = "D&O|byT,p#.Vf~4#vF0C8;KbY3LL/[HfP~2}n3fL*T D+NIC%@VhX+okx~";
$GLOBALS['priv_hash'] = "=p^w*Dk(V8f~9_RI7ZHf79>b,HNo&KJOPL;dn`&5TwI)FR_2#.6:C";
